...
"""Process-wide telemetry singletons for the content-processing pipeline.

A single :class:`TokenUsageEmitter` is constructed at import time so every
handler/executor shares the same App Insights connection-string resolution and
...
from libs.llm_token_telemetry import TokenUsageEmitter
