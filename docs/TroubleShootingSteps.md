...
If the problem persists, you can also raise an bug in our [Content Processing Github Issues](https://github.com/microsoft/content-processing-solution-accelerator/issues) for further support.
